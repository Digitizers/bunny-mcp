...
import { projectResponse, projectStorageListing } from "./project.js";
...
export function installProjection(http, mode = "api") {
  http.interceptors.response.use((res) => {
    // Non-JSON bodies (file downloads) are streamed through untouched: they are
    // the operator's own stored content, not Bunny account metadata.
